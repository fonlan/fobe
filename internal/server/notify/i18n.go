...
var zhText = map[string]string{
	...
	"Notification":                         "通知",
	"Panel login failed":                   "面板登录失败",
	"Panel login blocked (IP blacklisted)": "登录失败过多，来源 IP 已封禁",
	...
	// booleans and durations (login alerts, §15 实现修订 2026-09-20)
	"Yes":    "是",
	"No":     "否",
	"%d s":   "%d 秒",
	"%d min": "%d 分钟",
